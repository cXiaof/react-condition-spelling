...
function (_Component) {
  ...
  function ConditionSpellingBox(props) {
    ...
    var _Object$entries$ = _slicedToArray(_es6Shim.Object.entries(fields)[0], 2),
        field = _Object$entries$[0],
        type = _Object$entries$[1].type;

    var _Object$entries$2 = _slicedToArray(_es6Shim.Object.entries(symbols[type])[0], 2),
    ...
    initState.door = _es6Shim.Object.keys(doors)[0];
